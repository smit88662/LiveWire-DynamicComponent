                    ...
                    <div class="grid">
                             ...
                             <div
                                 ...
                                 @if ($loop->index === 0)
                                     <button class="customButton"
                                         ...
                                         wire:click.prevent="addRowForValue">Add</button>
                                 @else
                                     <button
                                         ...
                                         wire:click.prevent="removeRowForValue({{ $key }})">Remove</button>
                                 @endif
                             </div>
                     @endforeach
                     <div class="button" style="margin-top: 28px">
                         <button type="button" wire:click.prevent="store()"
                             ...
                             style="margin-left: 30px; margin-bottom: 30px" onclick="repeaterSave()">Create</button>
                     </div>
                 </form>
             </div>
         </div>
